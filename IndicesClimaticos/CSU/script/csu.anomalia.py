...
ds = xr.open_dataset('../processado/csu.anomalia.2021.nc')
...
EscalaValores = np.arange(-10, 12, 2)
...
ax.format(coast=False,
          ...
          lonlim=(LonW, LonE), 
          linewidth=0,
          suptitle='Anomalia de Número de Dias Consecutivos com Temperatura >=30°C - 2021', 
          suptitlepad=40)
...
fig.save(f'../figuras/csu.anomalia.2021.png', dpi=300, bbox_inches='tight', pad_inches=0.1)