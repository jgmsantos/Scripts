...
# Cria os diretórios: tif, netcdf e tmp e execute o script -> ./03get_data_NASA_GRACE.sh
# Disponibilidade do dado a cada 7 dias.
...
while [ ${data_inicial} -le ${data_final} ]; do
	...
	# Checo apenas um dos três arquivos e o seu status para saber se ele existe (0) ou não (8).
