...
netcdf = xr.open_dataset('./input/SPI_pantanal.nc', decode_times=False)

largura_barra = 0.25  # Largura da barra.
maximo_valor_y = 2.5  # Máximo valor do eixo y.
...
plt.ylim(minimo_valor_y, maximo_valor_y)  # Define o mínimo e máximo valor do eixo y.
...
plt.xticks(np.arange(21), fontsize=7, rotation='vertical')  # Rótulos do eixo x, tamanho e orientação.
