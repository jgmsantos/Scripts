...
ds = xr.open_dataset('../processado/csu.2021.nc')
...
ax.format(coast=False,
          ...
          lonlim=(LonW, LonE), 
          linewidth=0,
          suptitle='Número de Dias Consecutivos com Temperatura >=30°C - 2021', 
          suptitlepad=40)
...
fig.save(f'../figuras/csu.2021.png', dpi=300, bbox_inches='tight', pad_inches=0.1)